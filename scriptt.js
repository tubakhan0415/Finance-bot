...
delegateToLoanHandler(text) {
 ...
 // New method to handle profession selection
    ...
    // Direct user actions to appropriate handlers
    window.directTo = function(loanType) {
        ...
        if (loanType === 'degreeProgram' || loanType === 'financialProgram') {
            // Handle professional and financial programs more dynamically
            chatBoxInstance.promptForLoanDetails(loanType);
        } else {
